...
const ProductDataList: React.FC<ProductDataListProps> = (props) => {
    ...
    const [isOpenProductEditForm, setIsOpenProductEditForm] = useState<boolean>(
        false
    );
    const [isOpenConfirmDialog, setIsOpenConfirmDialog] = useState<boolean>(
        false
    );
    const [isOpenProductDetails, setIsOpenopenProductDetails] = useState<
        boolean
    >(false);
                            ...
                            <Grid item xs={2} className={classes.listItem}>
                                <Box key={product.code}>
                                    <ClearIcon
                                        ...
                                        onClick={() =>
                                            handleOpenConfirmDialog(product._id)
                                        }
                                    />
                                    <DescriptionIcon
                                        className={classes.actionIcon}
