    ...
    try {
        const products: AxiosResponse<ApiDataType> = await axios.get(
            baseUrl + '/api/product',
            {
                headers: {
                    Authorization:
                        'Basic eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVmYTAyMTEwODk1MzYyMjEzOGEyMzY4NyIsImlhdCI6MTYwNDkyNzA5MiwiZXhwIjoxNjA1MDEzNDkyfQ.2onFY3oTWPLFeJb_I9Yl930XmbViGcB0ka2b_DuPxDY'
                }
            }
        );
        return products;
